		...
		<div className="list-div">
			<div className="list-top">
				...
				<div className="list-btn">
					<button type="button" className="card-list-btn active" onClick={(e)=>changeListTypeEvt(e.target)}>카드형식 정렬</button>
					<button type="button" className="board-list-btn" onClick={(e)=>changeListTypeEvt(e.target)}>보드형식 정렬</button>
				</div>
			</div>
